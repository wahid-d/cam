        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KoreanName = table.Column<string>(maxLength: 255, nullable: true),
                    SchoolName = table.Column<string>(maxLength: 55, nullable: true),
                    Level = table.Column<string>(maxLength: 20, nullable: true),
                    Grade = table.Column<string>(nullable: true),
                    ParentPhone = table.Column<string>(maxLength: 20, nullable: true),
                    SelfPhone = table.Column<string>(maxLength: 20, nullable: true),
